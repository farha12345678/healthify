    ...
    <div className='container mx-auto my-20'>
      <div>
        ...
        <div className='mt-5'>
          ...
          >
          <SwiperSlide>
  <div className="card card-compact bg-base-100 w-80 relative group border  hover:border-purple-400 hover:bg-purple-100 transition-transform duration-300 ease-in-out">
